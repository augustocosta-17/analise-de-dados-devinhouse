...
# DATASET E LIMPEZA DE DADOS FEITOS NA AULA 1
# VIZUALIZAÇÃO COM O SEABORN:

import matplotlib.pyplot as plt
import seaborn as sns

# Gráfico de dispersão (scatter plot) entre idade e preço unitário
plt.figure(figsize=(10, 6))
sns.scatterplot(data=df_final, x='idade', y='preco_unitario', alpha=0.6)
plt.title('Relação entre Idade do Cliente e Preço Unitário')
plt.show()